...
hc <- reshape(hcare,
              varying = c("X2000", "X2001", "X2002", "X2003", "X2004", "X2005", "X2006",
...
life <- reshape(lifexpct1,
                varying = c("X1995", "X1996", "X1997", "X1998", "X1999", "X2000", "X2001", "X2002", "X2003", "X2004", "X2005",
...
life
#===============================================================================================================
# Merging life expectancy and cost datasets

hl <- sqldf("SELECT hc.[CountryName], hc.[CountryCode], hc.Year, hc.cost, life.Age
             FROM hc
             LEFT JOIN life ON hc.[CountryName] = life.[ï..CountryName] 
...
hl2 <- sqldf("SELECT hl.[CountryName], hl.[CountryCode], hl.Year, hl.cost, hl.Age, cregion.Region
              FROM hl
              LEFT JOIN cregion ON hl.[CountryCode] = cregion.[ï..CountryCode]
                                AND hl.[CountryName] = cregion.[CountryName]
              WHERE cregion.Region != ''")

# Impute average cost and age for NA entries
...
# Save cleaned data
write.csv(hl2, file = 'C:SCRIPTING FILES/R/mergcleaned.csv', row.names = FALSE)
#===============================================================================================================
#===============================================================================================================
